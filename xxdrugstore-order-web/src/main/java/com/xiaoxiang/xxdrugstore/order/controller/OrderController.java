package com.xiaoxiang.xxdrugstore.order.controller;
...
import com.xiaoxiang.xxdrugstore.bean.OmsOrderItem;
...
public class OrderController {
    ...
    public ModelAndView submitOrder(String receiveAddressId, BigDecimal totalAmount, String tradeCode, HttpServletRequest request, HttpServletResponse response, HttpSession session, ModelMap modelMap) {
        ...
        if (success.equals("success")) {
            ...
            List<OmsCartItem> omsCartItemDelList = new ArrayList<OmsCartItem>();
            ...
            // 将订单和订单详情写入数据库并且删除购物车的对应商品
            orderService.saveOrder(omsOrder,omsCartItemDelList);
            //更新购物车缓存
            cartService.flushCartCache(memberId);

            // 重定向到支付系统
            ModelAndView mv = new ModelAndView("redirect:http://payment.xxdrugstore.com:8087/index");
    ...
    @LoginRequired(loginSuccess = true)
    @ResponseBody
    public String addAddress(String name, String phone, String province, String city, String region, String detailAddress,String postCode,HttpServletRequest httpServletRequest) {
        ...
        umsMemberReceiveAddress.setPhoneNumber(phone);
        ...
        result=userService.addReceiveAddress(umsMemberReceiveAddress);
        return result;
    }
