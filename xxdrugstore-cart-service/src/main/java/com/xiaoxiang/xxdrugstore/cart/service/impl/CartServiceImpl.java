package com.xiaoxiang.xxdrugstore.cart.service.impl;

import com.alibaba.dubbo.config.annotation.Service;
import com.alibaba.fastjson.JSON;
import com.xiaoxiang.xxdrugstore.bean.OmsCartItem;
import com.xiaoxiang.xxdrugstore.cart.mapper.OmsCartItemMapper;
...
public class CartServiceImpl implements CartService {
    ...
    public void flushCartCache(String memberId) {
        ...
        jedis.del("user:"+memberId+":cart");//删除redis中原有的缓存购物车数据
    ...
    @Override
    public void delCart(List<OmsCartItem>  omsCartItems) {
